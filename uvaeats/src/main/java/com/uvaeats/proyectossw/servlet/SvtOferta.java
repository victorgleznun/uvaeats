 ...
 * @author fagon
 */
public class SvtOferta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SvtOferta</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SvtOferta at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("Anadir") != null) {
            ...
            misesion.setAttribute("ofertasSeleccionadas", cb);
